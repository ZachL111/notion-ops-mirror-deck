"""Regression checks for the notion-ops-mirror-deck casebook."""
...
from casebook.harness import assert_expected, notion_ops_mirror_deck_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_ops_mirror_deck_summary(), assert_expected())
