...
$repo = "notion-ops-mirror-deck"
$language = "JavaScript"
$category = "Automation"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/notion-ops-mirror-walkthrough.md")) {
